  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.features}>
        <Feature icon={require('../assets/padlock.png')} text={i18n.t('description1')} />
        <Feature icon={require('../assets/cross-platform.png')} text={i18n.t('description2')} />
        <Feature icon={require('../assets/fingerprint.png')} text={i18n.t('description3')} />
